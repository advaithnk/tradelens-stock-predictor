...
```bash
cd /Users/apple/Desktop/Enigma_24/backend
...
Add to crontab:
```bash
0 18 * * * cd /Users/apple/Desktop/Enigma_24/backend && python3 update_demo_data.py >> update.log 2>&1
```

### Run Weekly (Sundays at 6 PM)

```bash
0 18 * * 0 cd /Users/apple/Desktop/Enigma_24/backend && python3 update_demo_data.py >> update.log 2>&1
```
